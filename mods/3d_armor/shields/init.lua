...
if ARMOR_MATERIALS.wood then
	minetest.register_tool("shields:shield_wood", {
		...
		groups = {armor_shield=5, armor_heal=0, armor_use=2000, not_in_creative_inventory=1},
		wear = 0,
	})
	minetest.register_tool("shields:shield_enhanced_wood", {
		...
		groups = {armor_shield=8, armor_heal=0, armor_use=1000, not_in_creative_inventory=1},
		wear = 0,
	})
...
if ARMOR_MATERIALS.steel then
	minetest.register_tool("shields:shield_steel", {
		...
		groups = {armor_shield=10, armor_heal=0, armor_use=500, not_in_creative_inventory=1},
		wear = 0,
	})
end
...
if ARMOR_MATERIALS.bronze then
	minetest.register_tool("shields:shield_bronze", {
		...
		groups = {armor_shield=10, armor_heal=6, armor_use=250, not_in_creative_inventory=1},
		wear = 0,
	})
end
...
if ARMOR_MATERIALS.diamond then
	minetest.register_tool("shields:shield_diamond", {
		...
		groups = {armor_shield=15, armor_heal=12, armor_use=100, not_in_creative_inventory=1},
		wear = 0,
	})
end
...
if ARMOR_MATERIALS.mithril then
	minetest.register_tool("shields:shield_mithril", {
		...
		groups = {armor_shield=15, armor_heal=12, armor_use=50, not_in_creative_inventory=1},
		wear = 0,
	})
end
...
if ARMOR_MATERIALS.crystal then
	minetest.register_tool("shields:shield_crystal", {
		...
		groups = {armor_shield=15, armor_heal=12, armor_use=50, armor_fire=1, not_in_creative_inventory=1},
		wear = 0,
	})
end
