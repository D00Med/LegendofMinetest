...
xdecor.register("worktable", {
	...
	node_box = {
		type = "fixed",
		fixed = {
			{-0.3125, -0.5, -0.3125, 0.3125, 0.1875, 0.3125}, -- NodeBox1
			{0.3125, -0.5, 0.3125, 0.5, 0.1875, 0.5}, -- NodeBox2
			{-0.5, -0.5, -0.5, -0.3125, 0.1875, -0.3125}, -- NodeBox3
			{-0.5, -0.5, 0.3125, -0.3125, 0.1875, 0.5}, -- NodeBox4
			{0.3125, -0.5, -0.5, 0.5, 0.1875, -0.3125}, -- NodeBox5
			{-0.5, 0.1875, -0.5, 0.5, 0.5, 0.5}, -- NodeBox6
		}
	},
