...
minetest.register_craftitem("maptools:gold_coin", {
	description = S("Red Rupee"),
	inventory_image = "maptools_gold_coin.png",
	stack_max = 10000,
	groups = {not_in_creative_inventory = maptools_creative},
})

minetest.register_craftitem("maptools:nyan_coin", {
	description = S("Nyan Rupee"),
	inventory_image = "maptools_nyan_coin.png",
	stack_max = 10000,
	groups = {not_in_creative_inventory = maptools_creative},
})
