...
function object_drive(entity, dtime, speed, decell, shoots, arrow, reload, moving_anim, stand_anim, jump, jump_anim, shoot_anim, shoot_y, extra_yaw)
	--variables
	...
	if moving_anim ~= nil and not entity.moving and not hovering then
		entity.object:set_animation(moving_anim, 30, 0)
		entity.moving = true
	end
